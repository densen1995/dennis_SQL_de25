...
--create a sequence to generate values for employee_id column later
...
INSERT INTO
    staging.employees (department, employmnet_year)
VALUES
    ('Sales',2001),
    ('Logistics, 2002'),
    ('IT', 2002);

--insert with read_scv() function
INSERT INTO 
    staging.employees (department, employment_year)
    SELECT * FROM read_scv('data/employees.csv')
...
/*-----------
  ...
  /*==============
    ...
    ADD COLUMN pension_plan VARCHAR DEFAULT 'plan1'
